...
public class NeuralNetMono : MonoBehaviour
{
    public Layer [] layers;
    ...
    public class Layer
    {
        ...
        // calculate forward on the network
    ...
    // The "Brain" blackbox of the creature
    // It returns the output (what to do) after calculating our neural network
